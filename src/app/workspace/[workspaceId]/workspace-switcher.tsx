...
export const WorkspaceSwitcher = () => {
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger className="" suppressHydrationWarning asChild>
        <Button
          suppressHydrationWarning
          className="size-9 overflow-hidden bg-[#ababad] hover:bg-[#ababad]/80 text-slate-800 font-semibold text-xl ml-3 lg:ml-4 justify-center items-center"
        >
          {workspaceLoading ? (
